      ...
      <div class="front-block__inner">
        <div class="front-block__left">
          <h1 class="front-block__title _title">
            Услуги в Abakumov Clinic
          </h1>
          <div class="cursor">
            <?php include(get_template_directory() . '/assets/images/icons/cursor.svg'); ?>
          </div>
          <div class="front-block__services">
            <a class="front-block__service" href="#">
              <div class="front-block__service-wrapper">
                <img class="front-block__service-img _img" src="<?php echo get_template_directory_uri(); ?>/assets/images/front-block-10.webp" alt="front-block-10">
              </div>
            ...
            <a class="front-block__service" href="#">
              <div class="front-block__service-wrapper">
                <img class="front-block__service-img _img" src="<?php echo get_template_directory_uri(); ?>/assets/images/front-block-11.webp" alt="front-block-11">
              </div>
              <div class="front-block__service-info">
                <h4 class="front-block__service-title">
                  Ответы на часто
            ...
            <a class="front-block__service" href="#">
              <div class="front-block__service-wrapper">
                <img class="front-block__service-img _img" src="<?php echo get_template_directory_uri(); ?>/assets/images/front-block-12.webp" alt="front-block-12">
              </div>
              <div class="front-block__service-info">
                <h4 class="front-block__service-title">
                  Медицинские
            ...
            <a class="front-block__service" href="#">
              <div class="front-block__service-wrapper">
                <img class="front-block__service-img _img" src="<?php echo get_template_directory_uri(); ?>/assets/images/front-block-13.webp" alt="front-block-13">
              </div>
              <div class="front-block__service-info">
                <h4 class="front-block__service-title">
                  Мед-бот диагностики
            ...
            <a class="front-block__service" href="#">
              <div class="front-block__service-wrapper">
                <img class="front-block__service-img _img" src="<?php echo get_template_directory_uri(); ?>/assets/images/front-block-14.webp" alt="front-block-14">
              </div>
              <div class="front-block__service-info">
                <h4 class="front-block__service-title">
                  Онлайн-консультация
            ...
            <a class="front-block__service" href="#">
              <div class="front-block__service-wrapper">
                <img class="front-block__service-img _img" src="<?php echo get_template_directory_uri(); ?>/assets/images/front-block-15.webp" alt="front-block-15">
              </div>
              <div class="front-block__service-info">
                <h4 class="front-block__service-title">
                  Удалённая
